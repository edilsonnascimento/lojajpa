...
public class CadastroDeItensPedidos {
    ...
    public static void main(String[] args) {
        ...
        pedido1.getItens().forEach(i -> System.out.println(i.getPedido().getId() + "---" + i.getProduto().getNome()));
        pedido2.getItens().forEach(i -> System.out.println(i.getPedido().getId() + "---" + i.getProduto().getNome()));
        pedido3.getItens().forEach(i -> System.out.println(i.getPedido().getId() + "---" + i.getProduto().getNome()));
    ...
    public static void popularBancoDados(){
        ...
        Cliente cliente2 = new Cliente("Tomazio","111111");
